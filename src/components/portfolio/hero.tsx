  ...
  return (
    ...
    >
      ...
      <div className="relative lg:col-span-5 lg:pl-4">
            ...
            <div className="flex items-center gap-3">
               ...
               <div className="min-w-0 text-background">
                <div className="text-sm font-semibold">Government of Nepal</div>
                 <div className="text-xs opacity-80">Public Infrastructure · Nepal</div>
              </div>
            </div>
          </div>
        ...
        </div><a href="#experience" className="absolute -bottom-7 left-0 inline-flex items-center gap-4 bg-primary px-7 py-5 text-xs font-semibold uppercase tracking-[0.18em] text-primary-foreground transition-colors hover:bg-foreground">Explore career <span aria-hidden>→</span></a>
      </div>
      </div>
    </section>
  );
